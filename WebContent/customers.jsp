...
String result = DB.list((String)session.getAttribute("uname"),(String)session.getAttribute("psw"),"customers");
...
<form action="update" method="post">
	...
	<input type="text" placeholder="Location" name="Customer_Location" required>
